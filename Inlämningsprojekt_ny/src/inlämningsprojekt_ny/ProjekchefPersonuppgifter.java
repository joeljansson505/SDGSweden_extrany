 ...
 * @author paulu
 */
public class ProjekchefPersonuppgifter extends javax.swing.JFrame {
    ...
    public ProjekchefPersonuppgifter(InfDB idb, int aid, String inloggadAnvandare) {
        this.idb = idb;
        this.aid = aid;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ProjekchefPersonuppgifter.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(() -> {
            try{
                ...
                new ProjekchefPersonuppgifter(idb, 1, "admin").setVisible(true);
            }catch (InfException e){
                e.printStackTrace();
            }
        });
