 ...
 * @author paulu
 */
public class AdminPersonuppgifter extends javax.swing.JFrame {
    ...
    public AdminPersonuppgifter(InfDB idb, int aid, String inloggadAnvandare) {
        this.idb = idb;
        this.aid = aid;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AdminPersonuppgifter.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(() -> {
            try{
                ...
                new AdminPersonuppgifter(idb, 1, "admin").setVisible(true);
            }catch (InfException e){
                e.printStackTrace();
            }
        });
