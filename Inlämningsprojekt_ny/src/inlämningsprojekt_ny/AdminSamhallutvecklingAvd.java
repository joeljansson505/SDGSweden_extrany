 ...
 * @author joelj
 */
public class AdminSamhallutvecklingAvd extends javax.swing.JFrame {
     ...
     */
    public AdminSamhallutvecklingAvd(InfDB idb, String InloggadAnvandare, int aid) {
        this.idb = idb;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AdminSamhallutvecklingAvd.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
